...
#define  DEVICENAME      "CANKJncjksnkjcskjhascbbcjackajshck" 
#define  PRODUCTKEY      "CSvoiduaidvnadjkvahdvjkladhva"
#define  DEVICESECRE     "Wsdvndjhadjkahdfjkahdkjl" 
#define  BAD     		     "47.109.89.8" 

#define  DEVICESECRE_LEN      strlen(DEVICESECRE)

#define  SUBSCRIBE_TOPIC         "SmartpillboxSubA12"      
#define  P_TOPIC_NAME            "SmartpillboxPubA12"    //需要发布的主题   
//阿里云
