...
//        
        ...
        if (mqtt_CMDOutPtr != mqtt_CMDInPtr) {
               ...
               if (strstr((char *)mqtt_CMDOutPtr + 2, "zidong")) {   OperateMode=0;   oled_Clear(); Lock=0;}
					     if (strstr((char *)mqtt_CMDOutPtr + 2, "dingshi")) {  OperateMode=1;    oled_Clear(); Lock=1; }
//               if (strstr((char *)mqtt_CMDOutPtr + 2, "yuzhi"))     {OperateMode=2;   oled_Clear(); Lock=0;}
//               if (strstr((char *)mqtt_CMDOutPtr + 2, "shoudong")) { OperateMode=3;    oled_Clear();Lock=0;}
//							 if (strstr((char *)mqtt_CMDOutPtr + 2, "yuyin")) { OperateMode=4;    oled_Clear();Lock=0;}
							 
							 
						   if (strstr((char *)mqtt_CMDOutPtr + 2, "Time1"))    {WhatTime=1;}
							 if (strstr((char *)mqtt_CMDOutPtr + 2, "Time2"))    {WhatTime=2;}
							 if (strstr((char *)mqtt_CMDOutPtr + 2, "Time3"))    {WhatTime=3;}
							 if (strstr((char *)mqtt_CMDOutPtr + 2, "Time4"))    {WhatTime=4;}
							 if (strstr((char *)mqtt_CMDOutPtr + 2, "Time5"))    {WhatTime=5;}
							 

							 
							 	 if (strstr((char *)mqtt_CMDOutPtr + 2, "TimeFlag"))     {
									 IndexFlag4=3;
								 		 switch(WhatTime){
			   case 1:      State1=!State1;
				 ...
				 break;
					 ...
					 if (strstr((char *)mqtt_CMDOutPtr + 2, "Sensor5down"))  {
					 IndexFlag4=1;
						   switch(WhatTime){
			   case 1:      Hour1--;
				 break;
				 ...
				 break;
					...
					if (strstr((char *)mqtt_CMDOutPtr + 2, "Sensor5add"))    {
					 IndexFlag4=1;
     ...
     if (strstr((char *)mqtt_CMDOutPtr + 2, "Sensor6down")){
		      IndexFlag4=2;
		    switch(WhatTime){
			   case 1:      Min1--;
				 break;
    ...
    if (strstr((char *)mqtt_CMDOutPtr + 2, "Sensor6add"))  {
			   IndexFlag4=2;
				 switch(WhatTime){
			   case 1:      Min1++;
				 break;
